...
<section id="blog">
    <div class="container">
        <div class="section-header">
            <h3 class="section-title text-center wow fadeInDown animated"
                style="visibility: visible; animation-name: fadeInDown;">BLOG</h3>
            <p class="text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
                Afghan American Research and Academic Foundation</p>
        </div>
        ...
        <div class="row">
                    ...
                    <article>
                        ...
                        <footer class="entry-meta">
                            <span class="entry-author"><i class="fa fa-pencil"></i> <a
                                    href="#"><?=get_the_author_meta('display_name');?></a></span>
            ...
            <div class="col-sm-6">
                <div class="blog-post blog-media wow fadeInRight animated" data-wow-duration="300ms"
                    data-wow-delay="100ms"
                    style="visibility: visible; animation-duration: 300ms; animation-delay: 100ms; animation-name: fadeInRight;">
                ...
                <div class="blog-post blog-media wow fadeInRight animated" data-wow-duration="300ms"
                    ...
                    style="visibility: visible; animation-duration: 300ms; animation-delay: 200ms; animation-name: fadeInRight;">
                    <article class="media clearfix">
                        <div class="entry-thumbnail pull-left">
