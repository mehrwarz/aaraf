...
<section id="contact">
    <div
        ...
        <div
            ...
            <span id="3663E499-98B8-48C2-B682-A4CB4D9A9A21" style="display: none;">To navigate, press the arrow keys.</span>
                <div tabindex="-1" style="width: 26px; height: 37px; overflow: hidden; position: absolute; left: -13px; top: -37px; z-index: 0;">
                    <img alt="" src="http://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                        usemap="#gmimap0"
                        ...
                        name="gmimap0" id="gmimap0"><area log="miw"
                            coords="13,0,4,3.5,0,12,2.75,21,13,37,23.5,21,26,12,22,3.5" shape="poly" tabindex="-1"
                            title=""
    ...
    <div class="LGLeeN-keyboard-shortcuts-view" id="71AEFC57-B03C-4C80-AA6E-340AB31C9E1B" style="display: none;">
        <table>
            <tbody>
                <tr>
                    <td style="text-align: right;"><kbd class="VdnQmO-keyboard-shortcuts-view--shortcut-key"
                ...
                <tr>
                    <td style="text-align: right;"><kbd class="VdnQmO-keyboard-shortcuts-view--shortcut-key">+</kbd>
                    </td>
                ...
                <tr>
                    <td style="text-align: right;"><kbd class="VdnQmO-keyboard-shortcuts-view--shortcut-key">Home</kbd>
                    </td>
                    <td aria-label="Jump left by 75%.">Jump left by 75%</td>
                </tr>
                <tr>
                    <td style="text-align: right;"><kbd class="VdnQmO-keyboard-shortcuts-view--shortcut-key">End</kbd>
                    </td>
                    <td aria-label="Jump right by 75%.">Jump right by 75%</td>
                </tr>
                <tr>
                    <td style="text-align: right;"><kbd class="VdnQmO-keyboard-shortcuts-view--shortcut-key">Page
                            Up</kbd></td>
    ...
    <div></div>
    <div></div>
    <div><button draggable="false" aria-label="Toggle fullscreen view" title="Toggle fullscreen view" type="button"
    ...
    <div></div>
    <div>
        <div class="gmnoprint gm-bundled-control gm-bundled-control-on-bottom" draggable="false" data-control-width="40"
    ...
    <div>
        <div style="margin: 0px 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;"><a target="_blank"
                rel="noopener" title="Open this area in Google Maps (opens a new window)"
                aria-label="Open this area in Google Maps (opens a new window)"
                href="https://maps.google.com/maps?ll=52.365629,4.871331&amp;z=14&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
    ...
    <div>
        <div style="display: inline-flex; position: absolute; right: 0px; bottom: 0px;">
                ...
                <div draggable="false" class="gm-style-cc"
                    ...
                    <div
                        ...
                        <button draggable="false" aria-label="Map Data" title="Map Data" type="button"
                            ...
                            Data</button><span style="">Map data ©2023 Google</span>
                    </div>
                </div>
            </div>
            <div class="gmnoscreen">
            ...
            </div><button draggable="false" aria-label="Map Scale: 200 m per 34 pixels"
                title="Map Scale: 200 m per 34 pixels" type="button" class="gm-style-cc"
                aria-describedby="365ED63D-7E13-4741-B9CC-E592856A96B9"
                ...
                <div
                    style="position: relative; padding-right: 6px; padding-left: 6px; box-sizing: border-box; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(0, 0, 0); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                    <span>200 m&nbsp;</span>
                    <div style="position: relative; display: inline-block; height: 8px; bottom: -1px; width: 38px;">
                ...
                </div><span id="365ED63D-7E13-4741-B9CC-E592856A96B9" style="display: none;">Click to toggle between
            ...
            <div draggable="false" class="gm-style-cc"
                ...
                <div
                    ...
                    <a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google"
                        dir="ltr"
                        href="https://www.google.com/maps/@52.365629,4.871331,14z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
    ...
    <div
        ...
        <div><img alt="" src="http://maps.gstatic.com/mapfiles/api-3/images/google_gray.svg" draggable="false"
